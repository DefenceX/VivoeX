...
# We cannot check PNG files directly as the header changes after each generation so do a pixel by pixel check
...
foreach(FILENAME_FULL ${PNG_FILES})
  ...
  execute_process(COMMAND compare -metric AE ${FILENAME_FULL} ${CMAKE_SOURCE_DIR}/images/doxygen/${FILENAME_ONLY} diff.png ERROR_VARIABLE PIXELS_DIFF OUTPUT_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE)
