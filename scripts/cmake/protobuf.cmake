...
if(MSYS)
  set(PROTOC "${CMAKE_BINARY_DIR}/external/install/Program Files/protobuf/bin/protoc.exe")
  set(PROTOBUF_LIBRARY_DIR "${CMAKE_BINARY_DIR}external/install/Program Files/protobuf/lib")
else()
