...
ExternalProject_Add(
    ...
    GIT_SHALLOW         1
    CMAKE_ARGS          -DCMAKE_INSTALL_LIBDIR=/usr/${CMAKE_INSTALL_LIBDIR} -Dgflags_DIR=${GFLAGS_DIR} -DGFLAGS_USE_TARGET_NAMESPACE=ON -DCMAKE_CXX_FLAGS="-fPIC" -DCMAKE_INSTALL_MESSAGE=LAZY -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}
    GIT_TAG             v0.6.0
