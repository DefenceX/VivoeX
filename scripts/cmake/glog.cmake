...
ExternalProject_Add(
    ...
    GIT_SHALLOW         1
    CMAKE_ARGS          -Dgflags_DIR=${GFLAGS_DIR} -DCMAKE_INSTALL_LIBDIR=${CMAKE_INSTALL_LIBDIR} -DGFLAGS_USE_TARGET_NAMESPACE=ON -DCMAKE_CXX_FLAGS="-fPIC" -DCMAKE_INSTALL_MESSAGE=LAZY -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}
    GIT_TAG             v0.6.0  
