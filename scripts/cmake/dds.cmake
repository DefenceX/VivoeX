...
ExternalProject_Add(
    ...
    GIT_SHALLOW         5
    GIT_CONFIG          fetch.recurseSubmodules=true
    # CMAKE_ARGS          -DCycloneDDS_DIR=${CMAKE_BINARY_DIR}/external/cyclonedds/build -DCMAKE_INSTALL_MESSAGE=LAZY -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/external/install -DCMAKE_PREFIX_PATH=${CMAKE_BINARY_DIR}/external/install/usr/local/lib/cmake/CycloneDDS
