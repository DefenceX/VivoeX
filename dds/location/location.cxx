 ...
 */
void dateTime::year(uint16_t _year) { m_year = _year; }
...
bool dateTime::isKeyDefined() { return false; }

void dateTime::serializeKey(eprosima::fastcdr::Cdr& scdr) const { (void)scdr; }
...
bool geoLocation::isKeyDefined() { return false; }

void geoLocation::serializeKey(eprosima::fastcdr::Cdr& scdr) const { (void)scdr; }
