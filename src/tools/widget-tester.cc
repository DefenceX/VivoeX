...
static gva::WidgetOnscreenBezelBtns onscreen_bezel_btns(renderer, &touch);
...
static void do_drawing(cairo_t *cr, int width, int height) {
  ...
  switch (counter) {
    ...
    case 37: { 
      std::array<gva::FunctionKeys::Labels, 8> toplabels = {gva::LabelStates::kLabelEnabled,
                                                           true,
                                                           false,
                                                           "icon:minus",
                                                           "On",
                                                           ...
                                                           "",
                                                           ""};
      std::array<gva::FunctionKeys::Labels, 8> bottomlabels = {gva::LabelStates::kLabelEnabled,
                                                           true,
                                                           false,
                                                           "icon:plus",
                                                           "On",
                                                           ...
                                                           "",
                                                           ""};
      std::array<gva::FunctionKeys::Labels, 8> leftlabels = {gva::LabelStates::kLabelEnabled,
                                                           true,
                                                           false,
                                                           "icon:plus",
                                                           "On",
                                                           ...
                                                           "",
                                                           ""};
      std::array<gva::FunctionKeys::Labels, 8> rightlabels = {gva::LabelStates::kLabelEnabled,
                                                           true,
                                                           false,
                                                           "ECM",
                                                           "On",
      ...
      onscreen_bezel_btns.SetVisible(true);
      onscreen_bezel_btns.SetLabels(&toplabels, &bottomlabels, &leftlabels, &rightlabels);
      onscreen_bezel_btns.Draw();
      renderer.Draw();      
      cairo_surface_write_to_png(cairo_get_group_target(cr), (path + "/onscreen_bezel_btns.png").c_str());
    } break;
    default:
